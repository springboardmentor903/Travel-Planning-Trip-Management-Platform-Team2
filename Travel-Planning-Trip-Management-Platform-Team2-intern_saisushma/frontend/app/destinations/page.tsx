...
function DestCard({
    ...
    const imageSrc = imgError ? "/travel-hero.png" : (destination.imageUrl || "/travel-hero.png");
        ...
        >
            ...
            <div className="relative w-full h-44 overflow-hidden bg-gradient-to-br from-orange-500/15 to-amber-500/5 border-b border-white/10">
                ...
                <Image
                    ...
                    className={`object-cover group-hover:scale-[1.03] transition-all duration-500 ${imgLoaded ? "opacity-100" : "opacity-0"}`}
                />
