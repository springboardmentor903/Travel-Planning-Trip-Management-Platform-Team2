    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                ...
                const destRes = await apiClient.get<Destination>(
                    `/api/destinations/${id}`
                );
                ...
                // Fetch weather
                try {
                    const wRes = await apiClient.get<WeatherData>(
                    ...
                    setWeatherError(
                        `Weather error (${status ?? "network"}): ${msg}`
                    );
                } finally {
                        ...
                        <div className="p-7 sm:p-8">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <h1 className="text-3xl sm:text-4xl font-bold text-white leading-snug break-words">
                                        {destination.name}
                                    </h1>
                            ...
                            {destination.description && (
                                <div className="mt-6">
                                    ...
                                    <div className="inline-flex items-center gap-2 mb-3">
                                        ...
                                        <div className="glass-icon-chip shrink-0">
                                            <Icon
                                                name="book"
          ...
          ================================= */}
                    ...
                    <div className="glass-card p-7 sm:p-8">
                        ...
                        {!weatherLoading && weatherError && (
                            <div className="glass-banner glass-banner--error flex items-start gap-3">
                        ...
                        {!weatherLoading &&
                            ...
                            weather && (
                                <div>
                                    ...
                                    {/* Main weather */}
                                    {weather.weather?.[0] && (
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 p-5 bg-gradient-to-r from-orange-500/15 to-amber-500/10 rounded-2xl border border-white/10 backdrop-blur-sm">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-white/70 capitalize mt-0.5 text-sm">
...
function Icon({
    ...
    const paths: Record<IconName, React.ReactNode> = {
        ...
        city: (
            <>
                <path d="M4 21h16M6 21V8l6-4 6 4v13M9 10h1M14 10h1M9 14h1M14 14h1M11 21v-4h2v4" />
            </>
        ),

        cloud: (
            <>
                <path d="M7 18h10a4 4 0 0 0 .6-7.95A6 6 0 0 0 6.1 8.8 4.5 4.5 0 0 0 7 18Z" />
            </>
        ),

        feelsLike: (
            <>
                <path d="M12 3a3 3 0 0 0-3 3v7.1a5 5 0 1 0 6 0V6a3 3 0 0 0-3-3Z" />
                <path d="M12 8v7M10 17h4" />
            </>
        ),
        ...
        wind: (
            <>
                <path d="M3 8h11a2 2 0 1 0-2-2M3 12h15a2 2 0 1 1-2 2M3 16h8" />
            </>
        ),
    };
    ...
    return (
        <div className="glass-card-md p-5 flex items-center gap-3">
            ...
            <div className="min-w-0">
                ...
                <p className="font-semibold text-white mt-0.5 text-sm break-words">
                    {value}
                </p>
...
function WeatherCard({
    ...
    return (
        <div className="glass-card-md p-4 text-center">
            ...
            <Icon
                name={icon}
                className="mx-auto h-6 w-6 text-sky-200"
            />
